...
#         print(
#             f"✅ Ինդեքսը '{self.index_name}' հաջողությամբ ստեղծվեց/թարմացվեց:")
...
class AzureVectorService:
    ...
    def create_index(self):
        ...
        # Վեկտորային որոնման կարգավորում (HNSW)
        vector_search = VectorSearch(
            profiles=[VectorSearchProfile(
                name="myHnswProfile", algorithm_configuration_name="myHnsw")],
            algorithms=[HnswAlgorithmConfiguration(name="myHnsw")]
        ...
        # Semantic Search կարգավորումները հեռացված են Free Tier-ի անհամատեղելիության պատճառով
        index = SearchIndex(
